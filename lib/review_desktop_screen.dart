...
class ReviewDesktopScreen extends StatefulWidget {
  const ReviewDesktopScreen({Key? key}) : super(key: key);

  @override
  State<ReviewDesktopScreen> createState() => _ReviewDesktopScreenState();
}

class _ReviewDesktopScreenState extends State<ReviewDesktopScreen> {
  int currRating = 5;
  ...
  Widget _buildRatingStar(int index) {
    ...
    return const Icon(Icons.star,
        color: ThemeConfig.greyBlueColor, size: 110);
  }
